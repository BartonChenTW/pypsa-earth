...
const I18N = {
  en: {
    title: "Taiwan energy data", nav_home: "← Home", nav_dashboard: "Model dashboard", nav_sandbox: "Sandbox →", nav_sector: "Sector model (draft) →", nav_facts: "Key figures", nav_sources: "Data sources",
  ...
  zh: {
    title: "台灣能源資料", nav_home: "← 首頁", nav_dashboard: "模型儀表板", nav_sandbox: "情境沙盒 →", nav_sector: "部門耦合（草稿）→", nav_facts: "關鍵數據", nav_sources: "資料來源",
