...
const I18N = {
  en: {
    ...
    nav_data: "Taiwan energy data →", nav_sector: "Sector model (draft) →", nav_sandbox: "Sandbox →", nav_security: "Energy security →",
  ...
  zh: {
    ...
    nav_data: "台灣能源資料 →", nav_sector: "部門耦合（草稿）→", nav_sandbox: "情境沙盒 →", nav_security: "能源安全 →",
