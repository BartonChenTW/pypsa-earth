...
const PT = {
  en: {
    ...
    compare_note: "The official runs use the options and 2050 ranges of Taiwan's action plans, with no new nuclear unless the name says otherwise. The early test and sensitivities A–D (each changing one of its assumptions) allowed unlimited new nuclear and no imports; they only tested the model. The columns are the last year.",
  ...
  zh: {
    ...
    compare_note: "官方情境採用台灣各行動計畫的選項與 2050 年範圍，除名稱另有說明外不新建核電。早期測試與敏感度 A–D（各改變其一項假設）允許不設上限的新核電且無進口，僅用於測試模型。各欄為最後一年。",
